...
namespace SuperSocket.Connection
{
    public abstract class PipeConnection : PipeConnectionBase
    {
        ...
        protected override Task StartTask<TPackageInfo>(IObjectPipe<TPackageInfo> packagePipe)
        {
            ...
            return TaskEx.WhenAll(pipeTask, ProcessSends());
        }
            ...
            CancellationToken cancellationToken)
        {
            return TaskEx.WhenAll(
                FillPipeAsync(Input.Writer, packagePipe as ISupplyController, cancellationToken),
                base.StartInputPipeTask(packagePipe, cancellationToken));
        }
